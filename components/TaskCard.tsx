    ...
    >
      ...
      >
        <button
          ...
          className="rounded p-2.5 text-zinc-400 transition-colors hover:bg-zinc-700 hover:text-zinc-200"
        ...
        <button
          ...
          className="rounded p-2.5 text-zinc-400 transition-colors hover:bg-red-900/50 hover:text-red-400"
