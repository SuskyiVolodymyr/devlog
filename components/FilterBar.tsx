...
import { STATUS_OPTIONS } from '@/lib/styling'
...
const FILTER_OPTIONS: ReadonlyArray<{ label: string; value: TaskStatus | undefined }> = [
...
export default function FilterBar({ filters, onChange }: FilterBarProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <button
        onClick={toggleSort}
        className="flex items-center gap-1.5 rounded-lg border border-zinc-700 bg-zinc-800/60 px-3 py-1.5 text-sm font-medium text-zinc-400 transition-colors hover:border-zinc-600 hover:text-zinc-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
      >
